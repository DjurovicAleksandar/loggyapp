...
const expertises: Expertise[] = [
  {
    ...
    description:
      "App Architecture aims to create efficient frameworks for websites and applications, utilizing server deployment and cloud services for optimal performance.",
  },
  {
    id: 2,
    value: "Testing & Debugging",
    description:
      "Testing and Debugging guarantee applications reliability through strategic testing and efficient debugging.",
  },
  {
    id: 3,
